...
{
    public partial class Imagen : IDisposable
    {
        ...
        private void rectImagen_Loaded_1(object sender, RoutedEventArgs e)
        {
            if (HorarioActual != null)
            {
                ...
                if (HorarioActual.Docente.Foto != null)
                {
                    imgFoto.Source = ObtenerImagen(HorarioActual.Docente.Foto);
                }
            }
            else if (!string.IsNullOrEmpty(Contenido))
            {
                lblNoticia.Text = Contenido;
                lblCarrera.Visibility = Visibility.Hidden;
                lblGrupo.Visibility = Visibility.Hidden;
                lblMateria.Visibility = Visibility.Hidden;
                lblDocente.Visibility = Visibility.Hidden;
        ...
        private void lblNoticia_SizeChanged_1(object sender, SizeChangedEventArgs e)
        {
            //Control tmp = sender as Control;
